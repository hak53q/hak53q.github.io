...
The ZBLL sheets organize algorithms in groups of 12, by their corner permutation. We recommend learning each group of 12 at the same time. Learning too few algorithms at once hinders your 'Case-Alg' connection, and learning too many at once can be overwhelming.
...
3. Now go into the [ZBLL trainer](https://bestsiteever.net/zbll/#/select) and practice your algs. On the right side, choose the cases that you're going to practice, and hit ‘recap each case once’ on the left.
...
Tip: It's recommended to not practice all of the 12 algs at once. Instead, learn them in halves (so 6 each) or even in thirds (4 each), that way you can practice each case more.
