...
We currently have 167 solves from five ZZ solvers. Check them out!

<Cards>
  <Cards.Card
    icon={<Image src={logoEOCross} width={55} />}
    title="Yoruba's Official 6.51 ao5"
    href="/example-solves/yoruba-6.51-ao5"
  />
  <Cards.Card
    icon={<Image src={logoEOCross} width={55} />}
    title="Yoruba's Official 6.93 ao5"
    href="/example-solves/yoruba-6.93-ao5"
  />
  <Cards.Card
    icon={<Image src={logoEOCross} width={55} />}
  ...
  <Cards.Card
    icon={<Image src={logoEOCross} width={55} />}
    title="Luna's 7.73 ao12"
    href="/example-solves/luna-7.73-ao12"
  />
  <Cards.Card
    icon={<Image src={logoEOCross} width={55} />}
